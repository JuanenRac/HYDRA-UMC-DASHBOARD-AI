...
Application purement logicielle — sans hardware/firmware/os propres, jamais présents dans le modèle de ce projet (voir `SONNET/5.PLAN_EJECUCION_32_PROYECTOS_NUEVOS.txt` pour la règle d'élagage de tout l'écosystème).
