...
Reine Software-Anwendung — ohne eigene Hardware/Firmware/OS, die nie Teil der Vorlage dieses Projekts waren (siehe `SONNET/5.PLAN_EJECUCION_32_PROYECTOS_NUEVOS.txt` für die ökosystemweite Bereinigungsregel).
