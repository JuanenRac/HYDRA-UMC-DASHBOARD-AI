...
Pure-software web app — no hardware/firmware/os of its own, never part of this project's template (see `SONNET/5.PLAN_EJECUCION_32_PROYECTOS_NUEVOS.txt` for the ecosystem-wide pruning rule).
